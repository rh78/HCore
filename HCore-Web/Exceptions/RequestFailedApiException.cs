...
namespace HCore.Web.Exceptions
{
    public class RequestFailedApiException : ApiException
    {
        ...
        public const string SiteAnalysisIpAddressNotWhitelisted = "site_analysis_ip_address_not_whitelisted";
        public const string SiteAnalysisTokenInvalid = "site_analysis_token_invalid";
        public const string SiteAnalysisSignatureInvalid = "site_analysis_signature_invalid";
        public const string SiteAnalysisSignatureExpired = "site_analysis_signature_expired";
        public const string SiteAnalysisUserUuidMissing = "site_analysis_user_uuid_missing";
