        ...
        public override void OnResultExecuting(ResultExecutingContext context)
        {
            ...
            if (result is ViewResult || result is PageResult || result is LocalRedirectResult)
            {
                ...
                var csp = "default-src 'self' https://*.smint.io:40443 https://*.smint.io https://smintiocdn.azureedge.net https://cdn.smint.io; " +
                          ...
                          "connect-src 'self' *; " +
                          "style-src 'self' 'unsafe-inline' https://*.smint.io:40443 https://*.smint.io https://*.portalsapife.smint.io:43444 https://*.portalsapife.smint.io https://smintiocdn.azureedge.net https://cdn.smint.io https://fonts.googleapis.com https://unpkg.com https://w.chatlio.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; " +
                          "font-src 'self' 'unsafe-inline' data: https://*.smint.io:40443 https://*.smint.io https://smintiodevcachecdn.azureedge.net https://cachecdn.smint.io https://smintiocdn.azureedge.net https://cdn.smint.io https://fonts.gstatic.com https://w.chatlio.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; " +
                          "frame-src data: 'self' *; " +
                          "img-src * data:; " +
                          "media-src blob: *; " +
