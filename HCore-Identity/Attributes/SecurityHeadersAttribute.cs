    ...
    public class SecurityHeadersAttribute : ActionFilterAttribute
    {
        ...
        public override void OnResultExecuting(ResultExecutingContext context)
        {
            ...
            if (result is ViewResult || result is PageResult || result is LocalRedirectResult)
            {
                ...
                var csp = "default-src 'self' https://*.smint.io:40443 https://*.smint.io https://smintiocdn.azureedge.net https://cdn.smint.io https://*.portals.cloudinary.com:50443 https://*.portals.cloudinary.com; " +
                          "object-src 'none'; " +
                          $"frame-ancestors 'self' https://*.smint.io:40443 https://*.smint.io https://*.portals.cloudinary.com:50443 https://*.portals.cloudinary.com https://*.sharepoint.com https://*.officeapps.live.com https://*.veevavault.com{allowIFrameUrl}; " +
                          "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: http://127.0.0.1:8000 https://development-host.smint.io:8443 https://*.smint.io:40443 https://*.smint.io https://*.portals.cloudinary.com:50443 https://*.portals.cloudinary.com https://smintiocdn.azureedge.net https://cdn.smint.io https://code.jquery.com https://unpkg.com https://w.chatlio.com https://js.pusher.com https://cdn.segment.com https://www.google.com https://www.googletagmanager.com https://www.gstatic.com https://*.pusher.com https://appsforoffice.microsoft.com https://snap.licdn.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://npmcdn.com https://maps.googleapis.com;" +
                          "connect-src 'self' *; " +
                          "style-src 'self' 'unsafe-inline' https://*.smint.io:40443 https://*.smint.io https://*.portalsapib.smint.io:43444 https://*.portalsapib.smint.io https://*.portalsapife.smint.io:43444 https://*.portalsapife.smint.io https://*.portals.cloudinary.com:50443 https://*.portals.cloudinary.com https://*.portalsapib.portals.cloudinary.com:43444 https://*.portalsapib.portals.cloudinary.com https://*.portalsapife.portals.cloudinary.com:43444 https://*.portalsapife.portals.cloudinary.com https://staticcdn.smint.io https://smintiocdn.azureedge.net https://cdn.smint.io https://fonts.googleapis.com https://unpkg.com https://w.chatlio.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; " +
                          "font-src 'self' 'unsafe-inline' data: https://*.smint.io:40443 https://*.smint.io https://*.portals.cloudinary.com:50443 https://*.portals.cloudinary.com https://smintiodevcachecdn.azureedge.net https://smintiocachecdnstaging.azureedge.net https://cachecdn.smint.io https://smintiocdn.azureedge.net https://cdn.smint.io https://fonts.gstatic.com https://w.chatlio.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; " +
                          "frame-src data: 'self' *; " +
                          "img-src * data:; " +
                          "media-src blob: *; " +
